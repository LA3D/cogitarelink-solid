...
- `solid-uri-conformance` — URI structure for affordance IRIs (D84)
- `solid-profiles-and-conneg` — affordance descriptors are PROF ResourceDescriptors under the custom `wikirole:affordance` role (D86)
