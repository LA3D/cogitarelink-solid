...
D23: TBox cache in `/ontology/` container — local ontology stubs for offline/constrained queries **[2026-06-10 annotation: REPO-ONLY currently — the D109 §5 `ontology/` cache exists in the repo with the ground/declare/enumerate-defer policy, but no machinery deploys it to the Pod, so D49's "ground" copies aren't actually served. Whether the cache becomes Pod-resident is a Layer-0/index-view structure-design decision (PD audit 2026-06-10); until then D23 is aspirational.]**
